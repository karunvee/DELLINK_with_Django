            ...
            if( val != p_val){
                switch (val){
                    case "0":
                        ...
                        sg_m.className = "indicator-status green";
                        sg.className = "indicator-status green";
                        sy.className = "indicator-status";
                        sy_m.className = "indicator-status";
                        sr.className = "indicator-status";
                        sr_m.className = "indicator-status";
                        break;
                    case "1":
                        ...
                        sy.className = "indicator-status";
                        sy_m.className = "indicator-status";
                        sr.className = "indicator-status red";
                        sr_m.className = "indicator-status red";
                        break;
                    case "2":
                        ...
                        sy_m.className = "indicator-status yellow";
                        sr.className = "indicator-status";
                        sr_m.className = "indicator-status";
                        break;
                    case "3":
